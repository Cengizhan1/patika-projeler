...
public abstract class BattleLocation extends Location {
    ...
    BattleLocation(Player player, BaseEntity monster) {
        this.player = player;
    ...
    public void fight(Player player, BaseEntity monster) {
    ...
    public void printHealth(Player player, BaseEntity monster, boolean isPlayer) {
