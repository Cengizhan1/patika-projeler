...
public class Workshop extends Location {
    ...
    public boolean buyTool(Equipment equipment) {
        if (player.getCharacter().getMoney() >= equipment.getPrice()) {
            player.getCharacter().setMoney(player.getCharacter().getMoney() - equipment.getPrice());
            System.out.println("You Bought " + equipment.getName() + "!");
            return true;
        } else {
